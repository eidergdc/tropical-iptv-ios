class EpgModel {
  ...
  EpgModel.fromJson(Map<String, dynamic> json)
      : id = json['id']?.toString(),
        ...
        nowPlaying = json['now_playing']?.toString(),
        hasArchive = json['has_archive']?.toString();
  ...
  bool get isNowPlaying => nowPlaying == '1';
  bool get hasArchiveAvailable => hasArchive == '1';

  @override
  String toString() {
    return 'EpgModel(id: $id, title: $title, start: $start, end: $end)';
  }
}
